        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/all-posts" className="text-slate-300 hover:text-white transition-colors duration-200">
                  All Posts
                </Link>
              </li>
              <li>
                <Link to="/add-post" className="text-slate-300 hover:text-white transition-colors duration-200">
                  Write Post
                </Link>
              </li>
            </ul>
